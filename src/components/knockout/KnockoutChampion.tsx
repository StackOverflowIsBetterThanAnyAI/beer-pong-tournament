    ...
    return (
        <div className="flex flex-col gap-2 justify-center w-full max-w-96 text-normal bg-stone-200 drop-shadow-stone-600/60 drop-shadow-sm my-4 p-2 m-auto rounded-sm">
            ...
            {isAdmin ? (
                <>
                    <button
                        className="flex justify-center bg-stone-100 outline text-normal rounded-md mt-2 p-0.5 text-large h-7 sm:h-8 w-full focus-visible:bg-stone-50 outline-stone-500
