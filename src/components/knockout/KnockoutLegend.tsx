const KnockoutLegend = () => {
    return (
        <div className="flex flex-col max-w-96 w-full sm:w-2/3 lg:w-full sm:max-w-lg bg-stone-200 drop-shadow-stone-600/60 drop-shadow-sm p-2 rounded-sm m-auto mt-2">
