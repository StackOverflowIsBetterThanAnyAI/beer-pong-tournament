...
const NavigationLinks = () => {
    ...
    return (
        ...
        >
            ...
            <button
                onClick={handleClick}
                className={`animate-stone-50-red-200 relative isolate bg-stone-100 outline outline-red-400/90 text-normal rounded-md p-0.5 focus-visible:bg-stone-50 hover:bg-red-100 active:bg-red-200
